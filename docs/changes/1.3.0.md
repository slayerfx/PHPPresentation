...
- Added support for PHPStan 2.x (fixes static analysis on PHP 8.4 and 8.5) by [@slayerfx](http://github.com/slayerfx) in [#895](https://github.com/PHPOffice/PHPPresentation/pull/895)
